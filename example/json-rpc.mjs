...
// my installed NODE URL, when we first setup our node, inery has created our RPC in port :8888
...
const actor = process.env.INERY_ACCOUNT // The Signer, should match with your provided Private Key, burayada dikkat edelim
...
// A Function to create new data in our Valued Smart Contract, and call "create" function on our Smart contract, akilli kontratta bunuda yap bakalim
